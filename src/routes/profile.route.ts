...
profileRouter.patch("/", verifyLogin, validateProfileForUpdate(), handleErrors, wrapSync((req: Request, res:Response)=> profile.updateProfile(req, res)));
profileRouter.post("/create", validateProfileData(), handleErrors, verifyLogin, wrapSync((req:Request, res:Response)=>profile.createUserProfile(req, res)));
